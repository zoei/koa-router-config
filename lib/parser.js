...
function parseRouteConfig(routePath, routeConfig, options) {
  ...
  let { method, methods } = routeConfig
  methods = parsedRouteConfig.type === 'sub_route_config' ? ['get'] : Array.isArray(methods) && methods.length ? methods : method ? [method] : mtds
